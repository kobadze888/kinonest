...
export default function SyncDashboard() {
  ...
  const startSync = async () => {
    ...
    // ✅ წარწერები განახლებულია 1990-მდე
    const modeTitle = syncMode === 'new' ? "🚀 ახალი ფილმები (2020+)" : "📜 არქივი (1990-2019)";
    ...
    while (!stopRef.current) {
      try {
        ...
        if (data.logs && data.logs.length > 0) {
            ...
            addLog(`ℹ️ გვერდი ${page}: შედეგი ვერ მოიძებნა.`);
        }
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="bg-[#151a21] p-6 rounded-xl border border-gray-800 shadow-lg">
                ...
                <div className="flex flex-col gap-4">
                    ...
                    {/* 🔘 რეჟიმის არჩევა (განახლებული წარწერებით) */}
                    <div className="flex flex-col gap-2">
                        ...
                        >
                            <option value="new">🚀 ახალი (2020 - 2026)</option>
                    ...
                    {!isRunning ? (
                        ...
                        >
                            ...
                            {syncMode === 'new' ? 'დაწყება (ახალი)' : 'დაწყება (არქივი)'}
                        </button>
                    ) : (
                        <button 
                            onClick={stopSync}
